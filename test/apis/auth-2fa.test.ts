...
describe('2FA', () => {
    ...
    it('Call Create Application with wrong parameters', async () => {
        ...
        let error: Error = (
            await auth2fa.createApplication(1)
        ) as Error;
    ...
    it('Call Update Application with wrong parameters', async () => {
        ...
        let error: Error = (
            await auth2fa.updateApplication("test",1)
        ) as Error;
    ...
    it('Create Message Template', async () => {
        ...
        await auth2fa.createMessageTemplate(
    ...
    it('Create Message Template with wrong parameters', async () => {
        ...
        let error: Error = (
            await auth2fa.createMessageTemplate('1', 1)
        ) as Error;
    ...
    it('Get Message Template', async () => {
        ...
        await auth2fa.getMessageTemplate(
            '8F9B78',
            '1C8DA3'
            );
    ...
    it('Update Message Template', async () => {
        ...
        await auth2fa.updateMessageTemplate(
            '8F9B78',
            '1C8DA3',
            reqBody
        );
    ...
    it('Call Update Message Template with wrong parameters',
        async () => {
        expect.assertions(1);
        (axios as any).put.mockResolvedValue({});
    ...
    it('Send PIN code over SMS with wrong parameters', async () => {
        ...
        let error: Error = (await auth2fa.sendPINCodeSMS(
            1,
            false
        )) as Error
